<!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Dashboard Accounting</h2>
            <ol class="breadcrumb">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
              <div class="card mb-12">
                <div class="card-body" style="text-align: center;">
                  <h4>Selamat Datang Di Sistem Persediaan Dan Perkiraan Pada CV. Laksmi Dewata</h4> 
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                      <a href="dashboard_accounting.php?p=data_barang"><i class="fas fa-fw fa-book-open fa-2x text-info" style="margin-top: 18px;"></i></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">DATA BARANG MASUK</div>
                      <?php 
                         include"koneksi.php";
                         $order_b="SELECT * FROM tbl_barang_masuk";
                      ...
                      <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $count_b;  ?> Barang Masuk</div>
                    </div>
                    <div class="col-auto">
                      <a href="#"><i class="fas fa-fw fa-file fa-2x text-danger" style="margin-top: 18px;"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">DATA PEMBELIAN</div>
                      <?php 
                         include"koneksi.php";
                         $order_d="SELECT * FROM tbl_pembelian";
                      ...
                      <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $count_d;  ?> Pembelian</div>
                    </div>
                    <div class="col-auto">
                      <a href="dashboard_accounting?p=data_pembelian"><i class="fas fa-fw fa-book fa-2x text-warning" style="margin-top: 18px;"></i></a>
                    </div>
                  </div>
                </div>
              </div>
