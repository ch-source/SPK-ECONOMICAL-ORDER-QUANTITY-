          ...
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="post" action="proses_simpan_barang_keluar.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Tgl. Barang Keluar</label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Jml. Barang Keluar</label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-10">
                        ...
                        <a href="dashboard.php?p=data_barang_keluar" class="btn btn-danger"><i class="fas fa-sign-out-alt"></i> Batal</a>
                      </div>
                    </div>
                  </form>
                </div>
